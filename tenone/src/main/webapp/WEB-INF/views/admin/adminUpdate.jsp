...
<body>
	<form role="update_form" method="post" action="/admin/update" autocomplete="off">
	          ...
	          <div class="left_scrollbar p-4">
	            <div class="mb-3">
	              ...
	              <div class="input-group mb-3">
	                <input type="text" class="form-control border" name="goodsName" value="${goods.goodsName}"/>
	              </div>
	            </div>
	            ...
	            <div class="mt-3">
	              ...
	              <div class="input-group">
	                <input type="text" class="form-control right_border_none" name="goodsPrice" value="${goods.goodsPrice}" placeholder="0" maxlength="10" onkeyup="checkNumber(this);">
	            ...
	            <div class="mt-3">
	              ...
	              <div class="input-group">
	                <input type="text" class="form-control right_border_none" name="goodsStock" value="${goods.goodsStock}" placeholder="0" maxlength="10" oninput="checkNumber(this);">
	            ...
	            <div class="mt-3">
	              ...
	              <div class="input-group mb-3">
	                <input type="text" class="form-control border" name="goodsOtp" value="${goods.goodsOtp}">
	              </div>
	            </div>
	            ...
	            <div class="mt-3">
	              ...
	              <select class="form-select" id="inputGroupSelect" name="goodsDeli">
	                <option selected value="무료배송" ${goods.goodsDeli eq '무료배송' ? 'selected' : ''}>무료배송</option>
	                <option value="선불결제" ${goods.goodsDeli eq '선불결제' ? 'selected' : ''}>선불결제</option>
	                <option value="후불결제" ${goods.goodsDeli eq '후불결제' ? 'selected' : ''}>후불결제</option>
	                <option value="무료배송. 단, 제주 산간지역 4000원" ${goods.goodsDeli eq '무료배송. 단, 제주 산간지역 4000원' ? 'selected' : ''}>무료배송. 단, 제주 산간지역 4000원</option>
	                <option value="무료배송. 단, 제주 산간지역 배달 불가" ${goods.goodsDeli eq '무료배송. 단, 제주 산간지역 배달 불가' ? 'selected' : ''}>무료배송. 단, 제주 산간지역 배달 불가</option>
	              </select>
	            </div>
	            ...
	            <div class="mt-3">
	              ...
	              <div class="sellstate">
	                <div>
	                    <input type="radio" name="goodsStatu" value="판매중" ${goods.goodsStatu eq '판매중' ? 'checked' : ''}><span>판매 중</span>
	                </div>
	                <div>
	                    <input type="radio" name="goodsStatu" value="판매중지" ${goods.goodsStatu eq '판매중지' ? 'checked' : ''}><span>판매 중지</span>
	                </div>
	                <div>
	                    <input type="radio" name="goodsStatu" value="품절" ${goods.goodsStatu eq '품절' ? 'checked' : ''}><span>품절</span>
	                </div>
	               </div>
	             </div>
	            ...
	            <div class="mt-3">
	              ...
	              <select class="form-select" id="inputGroupSelect01" name="cateCode">
	                <option selected value="집들이 선물" ${goods.cateCode eq '집들이 선물' ? 'selected' : ''}>집들이 선물</option>
	                <option value="생일 선물" ${goods.cateCode eq '생일 선물' ? 'selected' : ''}>생일 선물</option>
	                <option value="취업 선물" ${goods.cateCode eq '취업 선물' ? 'selected' : ''}>취업 선물</option>
	                <option value="응원 선물" ${goods.cateCode eq '응원 선물' ? 'selected' : ''}>응원 선물</option>
	              </select>
	            </div>
	          </div>
	      ...
	      <div class="rightSidebar">
	        <div class="wrapper">
	          ...
	          <div class="admin_content">
	            <textarea class="textarea" name="goodsContents" value="${goods.goodsContents}"></textarea>
